...
# ╔═╡ 8e8cb76b-b0c9-4125-ad42-541b32859cdb
begin
	using DataFrames
	using CSV
end

# ╔═╡ f2b67502-3025-445c-bbc0-06a8dee7b253
using Plots  # This will install plots

# ╔═╡ 4e748c9e-ed3d-4def-b7bc-0d141a1c85c1
using PlutoUI

# ╔═╡ 99f23388-7c65-46ed-9459-fac2b3fb2e7b
df = CSV.read("/workspaces/unleashing-Julia/WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ e83921fd-9237-4365-8b63-e6146db902b0
df.Country_code === df[!, "Country_code"]


# ╔═╡ 691f50f6-fd26-4554-b812-7aa89a5881af
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ 804aa317-82b2-4461-8d8e-6451b333770d
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ 1913fb87-8e45-46f9-a6ff-b7ba41fa57a9
dates = sg_data[!, "Date_reported"]

# ╔═╡ 4efe4c15-0338-463a-bdb9-2babce0ec57a
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ 2f1b5062-9445-462d-8ddb-d52bd225604c
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ fffac7b3-31ca-49dd-9b33-91103f2835b3
...
# ╔═╡ 5b779ef5-7504-48af-92f6-a5806a321504
@bind slider_value Slider(0:10:1000)

# ╔═╡ 52148243-152a-4eed-b95e-62d94571ff7f
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ 15645a72-a315-4378-8e77-65c2abe39232
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ aade69f7-9741-48eb-8662-47d80457370f
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ 5607d3a6-8aa2-4377-8da0-87960bb27d03
